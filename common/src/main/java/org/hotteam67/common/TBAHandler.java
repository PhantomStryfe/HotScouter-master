...
public class TBAHandler {
    ...
    static class RetrieveUrl extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... input)
        {
            try {
                ...
                conn.setRequestProperty("X-TBA-Auth-Key", args[1]);
                ...
                if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) { // 200
                    ...
                    onCompleteEvent.onFail("TBA Retrieve URL: " + conn.getResponseCode());
                }
                conn.disconnect();
            } catch (Exception e) {
                onCompleteEvent.onFail("TBA Retrieve URL: " + e);
                Constants.Log(e);
            }
            return "";
        }
     ...
     */
    public static class Match implements Comparator<Match> {
        ...
        public int compare(Match match1, Match match2) {
            return Integer.compare(match1.matchNum, match2.matchNum);
        }

        public int compareTo(Match o2) {
            return Integer.compare(matchNum, o2.matchNum);
        }
    }
            ...
            public void onComplete(String result) {
                ...
                try {
                    ...
                    for (int i = 0; i < resultArray.length(); ++i) {
                        ...
                        match.matchNum = matchObject.getInt("match_number");
                    ...
                    Constants.Log(e);
                    returnEvent.onFail("TBA Matches: " + finalUrl.toString() + ", E:" + e + ", "
